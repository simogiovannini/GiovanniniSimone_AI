...
1. Tutti i dati presenti nella relazione sono stati ricavati ponendo
	qualsiasi seed o random_state al valore di 0 (zero).

2. Al termine dell'esecuzione verrano prodotti due file png, contenenti
	i punteggi ottenuti dai vari algloritmi.
	I file saranno salvati nella cartella contente il file main.py.

3. Gli altri file .py che sono importati in main.py, si trovano nella
	cartella source.
